...
Route::get('/index', function () {
    return view('CustomByMashrat.index');
});
Route::get('/p', function () {
    return view('CustomByMashrat.popularInstructor');
});
Route::get('customIns', 'CustomInstructorController@index');
     ...
     if(env('IS_INSTALLED') == 1){
        ...
        if(isset($zoom_enable) && $zoom_enable == 1){
            ...
            Route::prefix('zoom')->group(function (){
                ...
                // Route::get('ClassList', 'vClassController@vClassList')->name('zoom.vClassList');
                Route::get('vClass','vClassController@vClass')->name('zoom.vClass');
            });
        }
     }
    }
...
//      custom
      Route::resource('featureListing','FeaturedListingController');
      Route::resource('listingPaymentSetting','ListingPaymentSettingController');
      Route::get('list','LinstingRequestToAdminController@allListing')->name('list-req');
      Route::resource('listingRequested','LinstingRequestToAdminController');
      //end

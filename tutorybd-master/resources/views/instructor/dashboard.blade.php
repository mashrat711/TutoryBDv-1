...
<section class="content">
  ...
  <div class="row">
    <div class="col-lg-6 col-xs-6">
      <div class="small-box bg-red">
        <div class="inner">
          <h3><a href="#" data-toggle="modal" data-target="#myModalinstructor" title="Become An Instructor"><li><i class="fas fa-chalkboard-teacher"></i>{{ __('Wanna Be Featured?') }}</li></a>
          </h3>
        </div>
      </div>
</div>	</div>

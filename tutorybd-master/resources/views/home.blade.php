    ...
    <div class="recommendation-main-block  text-center" style="background-image: url('{{ asset('images/getstarted/'.$gets['image']) }}')">
        <div class="container">
            ...
            <div class="recommendation-btn text-white">
                <a href="{{ url('/customIns') }}" class="btn btn-primary " title="search">{{ $gets['button_txt'] }}</a>
            </div>
            @endif 
        </div>
    </div>
...
<section id="categories" class="categories-main-block">
    <div class="container">
        <h6 class="patners-heading text-center btm-40">What You Can Do As A Instructor?</h6>
        <div class="row">

                    <div class="col-lg-4 col-sm-6">
                        <div class="categories-block">
                            <img class="card-img-top" src="{{asset('demos/course/images/courses/3.jpg')}}" alt="Card image cap">
                        </div>
                    </div>
            <div class="col-lg-4 col-sm-6">
                <div class="categories-block">

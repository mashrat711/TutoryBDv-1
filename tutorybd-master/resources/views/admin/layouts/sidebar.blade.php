    ...
    <section class="sidebar">
      ...
      @if(Auth::User()->role == "admin")
        <ul class="sidebar-menu" data-widget="tree">
          ...
          <li class="{{ Nav::isRoute('meeting.create') }} {{ Nav::isRoute('zoom.show') }} {{ Nav::isRoute('zoom.edit') }} {{ Nav::isRoute('zoom.setting') }} {{ Nav::isRoute('zoom.index') }}  treeview">
            ...
            <ul class="treeview-menu">
              <li class="{{ Nav::isRoute('zoom.vClass') }}"><a href="{{route('zoom.vClass')}}"><i class="fa fa-circle-o"></i>{{ __('Zoom vClass') }}</a></li>
       ...
       @endif
          ...
          <li class="{{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('childcategory') }} {{ Nav::isResource('course') }} {{ Nav::isResource('bundle') }} {{ Nav::isResource('courselang') }} treeview">
            ...
            <ul class="treeview-menu">
                <li class="{{ Nav::isResource('category') }} {{ Nav::isResource('subcategory') }} {{ Nav::isResource('childcategory') }} {{ Nav::isResource('courselang') }} {{ Nav::isResource('coursereview') }} treeview">
                    ...
                    <li class="{{ Nav::isResource('bundle') }}"><a href="{{url('bundle')}}"><i class="fa fa-book" aria-hidden="true"></i><span>{{ __('adminstaticword.BundleCourse') }}</span></a></li>
          ...
          <li class="{{ Nav::isResource('classrooms') }}"><a href="{{url('classrooms')}}"><i class="fa fa-tags" aria-hidden="true"></i><span>{{ __('adminstaticword.Classrooms') }}</span></a></li>
          ...
          <li class="{{ Nav::isRoute('all.instructor') }} {{ Nav::isResource('requestinstructor') }} treeview">
           <a href="#">
            ...
            <li class=""><a href="{{url('listingRequested')}}"><i class="fa fa-circle-o"></i>Listing Request</a></li>
            <li class=""><a href="{{url('list')}}"><i class="fa fa-circle-o"></i>All Listings</a></li>

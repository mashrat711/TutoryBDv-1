		  	...
		  	<div class="panel-body">
		  		<form action="{{ route('sl.fb') }}" method="POST">
					...
					<br>
			  		...
			  		<input type="text" placeholder="https://yoursite.com/public/auth/facebook/callback" name="FACEBOOK_CALLBACK_URL" value="{{ $env_files['FACEBOOK_CALLBACK_URL'] }}" class="form-control" required>
			  		<br>
		...
		<div class="panel panel-danger">
			...
			<div class="panel-body">
			  	<form action="{{ route('sl.gl') }}" method="POST">
					...
					<br>
			  		<label for="">{{ __('adminstaticword.CallbackURL') }}:</label>
			  		<input type="text" placeholder="https://yoursite.com/auth/public/google/callback" name="GOOGLE_CALLBACK_URL" value="{{ $env_files['GOOGLE_CALLBACK_URL'] }}" class="form-control">
			  		<br>
		...
		<div class="panel panel-info">
		  ...
		  <div class="panel-body">
		  	<form action="{{ route('sl.git') }}" method="POST">
				...
				<br>
		  		<label for=""> {{ __('adminstaticword.CallbackURL') }}:</label>
		  		<input type="text" placeholder="https://yoursite.com/auth/public/google/callback" name="GITLAB_CALLBACK_URL" value="{{ $env_files['GITLAB_CALLBACK_URL'] }}" class="form-control">
		  		<br>
		  ...
		  <div class="panel-body">
		  	<form action="{{ route('sl.amazon') }}" method="POST">
		  		...
		  		<div class="row">
		  			...
		  			<div class="col-md-1">
		  				<br>
	                    <span toggle="#asecret" class="fa fa-fw fa-eye field-icon toggle-password5 display-inline-flex"></span>
	                </div>
		  		</div>
	  		
				<br>
		  		<label for=""> {{ __('adminstaticword.CallbackURL') }}:</label>
		  		<input type="text" placeholder="https://yoursite.com/auth/public/amazon/callback" name="AMAZON_LOGIN_REDIRECT" value="{{ $env_files['AMAZON_LOGIN_REDIRECT'] }}" class="form-control">
		  		<br>
			    <label for=""><i class="fa fa-gitlab"></i> {{ __('adminstaticword.EnableAmazonLogin') }}: </label>
				&nbsp;&nbsp;

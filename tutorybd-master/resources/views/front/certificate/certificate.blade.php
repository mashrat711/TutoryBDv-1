                ...
                <div class="cirtificate-border-one text-center">
                    <div class="cirtificate-border-two">
                       <div class="cirtificate-heading" style="">Certificate of Completion</div>
                        ...
                        @endphp
                       <p class="cirtificate-detail" style="font-size:30px">This is to certify that <b>{{ Auth::User()['fname'] }}</b> successfully completed <b>{{ $course['title'] }}</b> online course on <br>
